...
class USBDeviceManager:
    ...
    def get_connected_usb_devices(self, device_node):
        ...
        self.usb_class.usb_info_manager.add_usb_info(device["Serial number"],device["Label"],
                                                     device["Device"],device["Mount Point"], register_bool = True, current_bool = True, active_bool = True)
