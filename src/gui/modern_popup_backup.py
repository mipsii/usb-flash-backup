...
class ModernBackupPopup(QDialog):
    ...
    def __init__(self, modified_files=None, new_files=None, deleted_files=None, parent=None):
        ...
        self.translation_manager.add_widget(self.status_bar, _("Prilagođeni status bar"))
        ...
        self.translation_manager.add_widget(self.cancel_button, _("Otkaži"))
        self.translation_manager.add_widget(self.backup_button, _("Pokreni backup"))
