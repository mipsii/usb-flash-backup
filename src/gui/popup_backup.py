...
class BackupPopup (QDialog):
    def __init__(self, parent=None):
        ...
        self.modified_files_tab = self._create_file_list_tab(_("Izmenjeni fajlovi:"))
        ...
        self.backup_button = QPushButton(_("Pokreni backup"), self)
        self.cancel_button = QPushButton(_("Otkaži"), self)
