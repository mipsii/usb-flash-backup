...
class FileExplorerView(QWidget):
    ...
    def init_ui(self):
        ...
        QTreeView::item:nth-child(odd) {
            background-color: #e8f5e9;  /* Svetlo zelena za neparne redove */
        }

        QTreeView::item:nth-child(even) {
            background-color: #ffffff;  /* Bela pozadina za parne redove */
        }

        QTreeView::item {
        padding-left: 0px;  /* Ukloni eventualne razmake sa leva */
        margin-left: 0px;   /* Ukloni margine sa leva */
