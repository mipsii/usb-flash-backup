...
class MainWindow(QMainWindow):
    ...
    def _signals(self):
        ...
        self.signal_manager.connect_signal("sigUpDateGui", self, "file_change_method")
    ...
    def handle_usb_event(self, action, deviceID):
        ...
        if action == "add":
            ...
            self.signal_manager.emit_signal("sigUsbStatusChanged", self.usb_class.usb_info[serial_number])
            ...
            if device:
                ...
                self.ui_logic.usb_remove()
                self.signal_manager.emit_signal("sigRemoveUsb", serial_number)
                print("......signal sigRemoveUsb je posalt")
            else:
                print("laznjak")
