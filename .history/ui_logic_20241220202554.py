...
class UiLogic(QObject):
    ...
    def _initiate(self):
        ...
        self.upddate_gui.connect(self.ui.update_usb_status)
    ...
    def on_item_clicked(self, item):
        ...
        if self.selected_item == item:
            ...
            print(f"ser i lista je .... {serial} ....{usb_data}")
            self.upddate_gui.emit(serial, usb_data)
                
    def usb_status_to_add_usb_wrapper(self, serial_number):
        self.add_usb()
