...
class UiLogic(QObject):
    ...
    def on_backup_clicked(self, item):
        ...
        self.main_window.backup_files_index(backup_index)
        #merged_state = asyncio.create_task(self.main_windows.recursive_backup_merge(self.main_windows.ui_logic.history, backup_index))
        print(f"backup po indexu { backup_index} je ... ")