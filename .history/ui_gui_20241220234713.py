from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QListWidget, QSplitter,QListWidgetItem, QHBoxLayout
...
class UiGui:
    ...
    def setupUi(self, MainWindow):
        ...
        # Naslov iznad liste
        title_widget = QWidget(self.left_widget)
        title_layout = QHBoxLayout(title_widget)

        # Naslov
        title_label = QLabel("Backups", title_widget)
        title_label.setStyleSheet("""
            ...
            border-radius: 10px;
            margin-bottom: 10px;  /* Razmak između naslova i liste */
            text-align: center;
            min-width: 100px;  /* Min širina za lepo poravnanje */
        """)
        title_layout.addWidget(title_label)

        # Dodavanje widget-a naslova iznad liste
