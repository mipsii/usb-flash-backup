...
class MainWindow(QMainWindow):
    ...
    def handle_usb_event(self, action, deviceID):
        ...
        if action == "add":
            ...
            if  serial_number in self.usb_class.usb_info:
            ...
            serial_number,_ = self.usb_class.usb_device.find_device(device = deviceID)
    ...
    async def analyz_files(self):
        ...
        self.file_change = FileChangeManager( usb_backup, mount)
