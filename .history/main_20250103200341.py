...
class MainWindow(QMainWindow):
    ...
    def _signals(self):
        ...
        self.signal_manager.connect_signal("finished", self, "dd")
    ...
    def handle_usb_event(self, action, deviceID):
        ...
        if action == "add":
            ...
            if  not serial_number in self.usb_class.usb_info:
                ...
                self.usb_class.update_usb_info(serial_number, {'DeviceID': deviceID})
                self.usb_class.update_usb_info(serial_number, {'Mount Point': mount_point})
