...
class MainWindow(QMainWindow):
    ...
    def _initiate(self):
        ...
        self.file_collector.send_merged_state.connect(self.dd(merged_state))
    ...
    def backup_files_index(self, target):
        ...
        return  loop.create_task(self.file_collector.recursive_backup_merge(self.history, target_index=target))
