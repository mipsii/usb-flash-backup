...
class FileExplorerView(QWidget):
    ...
    def populate_files(self):
        ...
        self.tree_view.setColumnWidth(155, 300) # Maksimalno 300px

        # Postavite fiksne širine za druge dve kolone (ako su fiksne)
        self.tree_view.setColumnWidth(1, 100, 155)  # Širina za veličinu
        self.tree_view.setColumnWidth(2, 150, 222)  # Širina za datum poslednje promene
