...
class UiLogic(QObject):
    ...
    def _initiate(self):
        ...
        self.upddate_gui.connect(lambda: asyncio.create_task(self.main_window.analyz_files(sserial_number)))
    ...
    def on_item_clicked(self, item):
        ...
        if self.selected_item == item:
            ...
            self.analyze_files.connect(lambda: asyncio.create_task(self.file_change.analyze_changes(serial)))
