...
from PySide6.QtWidgets import  QDialog, QWidget, QVBoxLayout, QLabel, QPushButton, QListWidget, QSplitter
...
class Ui_USBBackup:
    ...
    def setupUi(self, MainWindow):
        ...
        self.left_widget.setStyleSheet("background-color: red;")
        self.left_label = QLabel("Levi deo", self.left_widget)
    ...
    def adjust_window_size(self):
        ...
        width = 155  # Minimalna širina središnjeg dela
        if self.left_widget.isVisible():
            width += 195  # Dodaje širinu levog dela
        if self.right_widget.isVisible():
            width += 222  # Dodaje širinu desnog dela
        current_geometry = self.MainWindow.geometry()
        self.MainWindow.setFixedWidth(width)  # Postavlja novu širinu prozora
        self.MainWindow.setGeometry(QRect(current_geometry.x() , current_geometry.y(), width, current_geometry.height()))
