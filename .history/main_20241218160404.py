...
class MainWindow(QMainWindow):
    ...
    def _initiate(self):
        self.file_change.history_changed.connect(self.ui.update_backup_list)
        pass
    ...
    async def analyz_files(self,usb_backup, sserial_number):
        ...
        # usb_backup = details["Mount Point"]
        ...
        self._initiate()
        #self.file_change.history = {"new_file": "example.txt"}  # Ovo bi trebalo da pokrene setter
        #await self.file_change.analyze_changes()
        #history = self.file_change.history
        #self.ui.update_backup_list(history)
    ...
    def on_change_button_clicked(self):
        ...
        if self.ui.changeButton.text() == "Backup":
            ...
            asyncio.create_task(self.file_change.gg())
    ...
    #         item_height = 30
    #         if num_items > 0:
    #             self.ui.usb_list_widget.setVisible(True)
    #             self.ui.usb_list_widget.setFixedHeight(min(num_items, max_visible_items) * item_height)
    #         else:
