...
class ModernBackupPopup(QDialog):
    ...
    def _enable_hover(self, list_widget):
        """
        Omogućava praćenje hover događaja na listi.
        """
        list_widget.setMouseTracking(True)  # Omogućavanje praćenja miša
        list_widget.itemEntered.connect(self._on_item_hovered)  # Povezivanje hover događaja
