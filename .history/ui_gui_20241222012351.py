from PySide6.QtWidgets import QWidget, QVBoxLayout, QLabel, QPushButton, QListWidget, QSplitter,QListWidgetItem, QApplication, QMainWindow
...
class UiGui:
    def __init__(self, main_windows):
        ...
        self.raise_()  # Podiži ga ispred USB prozora
        self.activateWindow()  # Aktiviraj navigacijski prozor
