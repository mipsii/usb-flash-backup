...
class UiGui:
    ...
    def setupUi(self, MainWindow):
        ...
        self.main_windows.translation_manager.add_widget(self.main_windows, _("USB Backup"))
        ...
        self.main_windows.translation_manager.add_widget(self.lang_selector, [_("English"), _("Srpski"), _("Czesky")])
