...
class MainWindow(QMainWindow):
    ...
    def _signals(self):
        ...
        self.signal_manager.connect_signal_async("upddate_gui", self, "file_change_method")
        self.signal_manager.connect_signal("finnish", self, "dd")
        self.signal_manager.connect_signal("signal_gui", self, "signal_gui")
        #self.signal_manager.connect_signal("send_merged_state",self, "manipulation_usb")
    ...
    async def analyz_files(self,sserial_number, usb_backup = None):
        ...
        self.file_change_method(backup_path, usb_backup)
    ...
    def file_change_method(self, backup_path, usb_backup = None):
        self.file_change = FileChangeManager( backup_path, usb_backup )
    ...
    def manipulation_usb(self):
        ...
        if details["Is registar"]:
            print("saljem signal iz manipulation usn ")
