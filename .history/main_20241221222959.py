...
class MainWindow(QMainWindow):
    ...
    def _initiate(self):
        ...
        self.file_collector.send_merged_state.connect(self.dd)
    ...
    def backup_files_index(self,backup_path, target):
        ...
        loop.create_task(self.file_collector.recursive_backup_merge( backup_path, self.history, target_index=target))
