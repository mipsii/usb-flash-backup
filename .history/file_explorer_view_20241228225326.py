...
class FileExplorerView(QWidget):
    ...
    def init_ui(self):
        ...
        self.tree_view.setColumnWidth(0, 333)  # Početna širina prve kolone (155px)

        # Automatski prilagoditi širu prozora prema širinama kolona
        total_width = 155 + 100 + 155  # Ukupna širina svih kolona
        self.setMinimumSize(total_width, self.height())  # Povećava širinu prozora prema ukupnoj širini kolona
