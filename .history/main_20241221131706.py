...
class MainWindow(QMainWindow):
    ...
    def _initiate(self):
        ...
        self.file_change.history_changed.connect(self.history) 
    ...
    def backup_files_index(self, target):
        history = 0
        self.file_collector.recursive_backup_merge(self, history, current_index=0, target_index=target, merged_state=None)
