...
class FileCollector(QObject):
    ...
    def __init__(self):
        ...
        self.current_usb_path = self.config.get_backup_config()
    ...
    def merge_backups(self, current_path, previous_state):
        ...
        #print(f"spojeni fajlovi su ......... { merged_state }")
        return merged_state

    async def recursive_backup_merge(self, history, target_index=None):
        """
    ...
    def prosledjeni(self, history, current_index, target_index, merged_state):
        ...
        if current_index > target_index or current_index >= len(history):
                ...
                print(f"poslat signal sa podacima .........{merged_state}")
                return merged_state 
