...
class FileExplorerView(QWidget):
    ...
    def init_ui(self):
        ...
        self.resize(total_width, self.height())  # Povećava širinu prozora prema ukupnoj širini kolona
    ...
    def populate_files(self):
        ...
        # Automatski prilagodite širinu kolona na osnovu njihovog sadržaja
        self.tree_view.resizeColumnToContents()

        # Dodajte malo prostora (padding) oko prozora
