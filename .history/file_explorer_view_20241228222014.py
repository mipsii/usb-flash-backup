...
class FileExplorerView(QWidget):
    ...
    def init_ui(self):
        ...
        self.model.setHorizontalHeaderLabels(['Name', 'Size <br>(bytes)', 'Last Modified'])
    ...
    def populate_files(self):
        ...
        self.tree_view.setColumnWidth(0, min(self.tree_view.columnWidth(0), 300))  # Maksimalno 300px

        # Postavite fiksne širine za druge dve kolone (ako su fiksne)
        self.tree_view.setColumnWidth(1,  min(self.tree_view.columnWidth(0), 100))  # Širina za veličinu
        self.tree_view.setColumnWidth(2,  min(self.tree_view.columnWidth(0), 150))  # Širina za datum poslednje promene
