...
class MainWindow(QMainWindow):
    ...
    def _initiate(self):
        ...
        self.ui_logic.upddate_gui.connect(self.analyz_files)
    ...
    async def analyz_files(self,usb_backup, sserial_number):
        ...
        self.file_change = FileChangeManager( backup_path, usb_backup=None )
        print(f"kreiran file_change")
        self.collect_files(sserial_number)
        #await self.file_change.analyze_changes()
        
    def collect_files(self, serial):
        self._initiate()
