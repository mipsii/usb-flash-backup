...
from PySide6.QtWidgets import (
    ...
    QPushButton, QLabel, QListWidget, QApplication, QStatusBar
)
...
class ModernBackupPopup(QDialog):
    ...
    def __init__(self, modified_files=None, new_files=None, deleted_files=None, parent=None):
        ...
        self.status_bar.setStyleSheet("color: white; background-color: #2b2b2b;")
    ...
    def _load_list(self, list, files):
        for file in files:
                ...
                # Povezivanje klika sa prikazom pune putanje u status baru
                list.itemClicked.connect(
                    lambda item, path=file: self.status_bar.showMessage(path)
                )
