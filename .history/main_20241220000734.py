...
class MainWindow(QMainWindow):
    ...
    def _initiate(self):
        ...
        self.usb_status_changed.connect(self.usb_status_to_add_usb_wrapper)  # Wrapper poziva add_usb
    ...
    def handle_usb_event(self, action, deviceID):
        ...
        if device:    
            ...
            self.ui_gui.update_usb_status(serial_number, self.usb_class.usb_info[serial_number])
