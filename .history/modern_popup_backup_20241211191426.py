...
class ModernBackupPopup(QDialog):
    ...
    def __init__(self, modified_files=None, new_files=None, deleted_files=None, parent=None):
        ...
        modified_files_list.mouseMoveEvent = self._on_mouse_move
        new_files_list.mouseMoveEvent = self._on_mouse_move
        deleted_files_list.mouseMoveEvent = self._on_mouse_move
